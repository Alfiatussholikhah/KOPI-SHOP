...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light p-100">
        <a class="navbar-brand" href="#">
            <img src="assets/logo.png" width="30" height="30" class="d-inline-block center-top" alt="">
            Alp Kopi
        </a>
    ...
    <footer class="mt-5 bg-dark d-flex justify-content-center align-items-center" style="height: 96px;">
        <p style="margin-bottom: 0;" class="text-light">2022 &copy; ALFIATUS SHOLIKHAH</p>
    </footer>
